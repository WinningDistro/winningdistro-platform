        ...
        <div className="container mx-auto max-w-md">
          <Card className="bg-black border-green">
            <CardHeader className="text-center">
              <Music className="h-12 w-12 text-green mx-auto mb-4" />
              <CardTitle className="text-gold text-2xl">Create Your Account</CardTitle>
            ...
            <CardContent className="space-y-4">
              <div>
                <label className="block text-gold text-sm font-medium mb-2">Artist/Band Name</label>
                <input
                  type="text"
                  placeholder="Your artist name"
                  className="w-full px-4 py-3 bg-zinc-900 border border-green rounded text-white placeholder-gray-400 focus:border-gold focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-gold text-sm font-medium mb-2">Email Address</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-gold text-sm font-medium mb-2">Password</label>
                <input
                  type="password"
              ...
              <p className="text-center text-white text-sm">
                ...
                <Link to="/login" className="text-green hover:text-gold">Sign in</Link>
              </p>
            </CardContent>
          </Card>
        </div>
